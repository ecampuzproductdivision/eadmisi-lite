  ...
  <div class="row justify-content-center">
    <div class="col-lg-8">
      ...
      <div class="card border-1 shadow-sm mb-4">
        ...
        <!-- Bayar Button (HIDDEN when invoice already exists!) -->
        <div class="card-footer bg-white border-top py-3">
          ...
          @elseif($payment)
            {{-- Invoice already exists → hide Bayar Sekarang, show info --}}
            ...
            @if($payStatus === 'pending')
              <div class="alert alert-info border-0 shadow-sm mb-0 d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <p class="small mb-0">Invoice telah diterbitkan. Silakan lakukan pembayaran menggunakan Kode Billing / Virtual Account di atas. Tombol "Bayar Sekarang" disembunyikan karena invoice sudah aktif.</p>
                </div>
              </div>
