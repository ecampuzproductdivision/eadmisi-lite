...
<main class="p-2">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Tambah Periode Baru</li>
        </ol>
    </nav>
    <hr>
    ...
    <div class="d-flex align-items-top gap-3 my-5">
        ...
        <div>
            <h1 class="mb-1 fw-bold">Tambah Periode Baru</h1>
            <p class="text-muted mb-0">Buat tahun akademik dan semester baru untuk pendaftaran mahasiswa baru.</p>
        </div>
    </div>
