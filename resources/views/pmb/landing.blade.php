...
<head>
    ...
    <title>PMB | Penerimaan Mahasiswa Baru - eAkademik</title>
    ...
    <style>
        ...
        [data-bs-theme="dark"] .feature-card { border-color: rgba(255,255,255,0.05); }

        /* ===== LIGHT MODE: Semua putih ===== */
        ...
        /* CTA */
        [data-bs-theme="light"] section[style*="linear-gradient"] {
            background: #ffffff !important;
        }
        ...
        [data-bs-theme="light"] section[style*="linear-gradient"] .btn-outline-light:hover {
            background: #f8f9fa;
        }
...
<body>
            ...
            <div class="row align-items-center min-vh-100 py-8">
                <div class="col-lg-7 py-8">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <a href="#tentang" class="btn btn-outline-light btn-lg d-flex align-items-center gap-2 px-5">
                            <i class="ti ti-info-circle fs-4"></i> Pelajari Lebih
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center g-6">
                <div class="col-lg-6">
                    ...
                    <h2 class="fw-bold display-6 mb-4">Mengapa Memilih<br>Kampus Kami?</h2>
                    <p class="text-muted mb-6" style="max-width: 480px;">Kami berkomitmen untuk memberikan pendidikan berkualitas dengan kurikulum yang relevan terhadap kebutuhan industri dan perkembangan teknologi terkini.</p>
                    <div class="d-flex flex-column gap-4">
                        <div class="d-flex gap-3">
                            <div class="icon-shape icon-md bg-danger-subtle text-danger rounded-3 flex-shrink-0 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px;"><i class="ti ti-certificate fs-4"></i></div>
                            <div><h6 class="fw-bold mb-1">Terakreditasi Unggul</h6><p class="text-muted small mb-0">Terakreditasi A oleh BAN-PT dengan nilai unggul</p></div>
                        </div>
                        <div class="d-flex gap-3">
                            <div class="icon-shape icon-md bg-success-subtle text-success rounded-3 flex-shrink-0 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px;"><i class="ti ti-affiliate fs-4"></i></div>
                            <div><h6 class="fw-bold mb-1">Jaringan Luas</h6><p class="text-muted small mb-0">Kerjasama dengan 200+ perusahaan dan institusi</p></div>
                        </div>
                        <div class="d-flex gap-3">
                            <div class="icon-shape icon-md bg-info-subtle text-info rounded-3 flex-shrink-0 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px;"><i class="ti ti-device-laptop fs-4"></i></div>
                            <div><h6 class="fw-bold mb-1">Pembelajaran Modern</h6><p class="text-muted small mb-0">Sistem informasi akademik terintegrasi dan mudah diakses</p></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section id="program" class="py-8 bg-body-tertiary">
        <div class="container">
            ...
            <div class="row g-4">
                @php
                    $programs = [
                        ['icon' => 'ti-device-analytics', 'color' => 'danger', 'name' => 'Teknik Informatika', 'title' => 'Sarjana Komputer (S.Kom)', 'desc' => 'Mempelajari pengembangan perangkat lunak, kecerdasan buatan, dan keamanan siber.'],
                        ['icon' => 'ti-building-bank', 'color' => 'warning', 'name' => 'Manajemen', 'title' => 'Sarjana Manajemen (S.M.)', 'desc' => 'Mempelajari strategi bisnis, kewirausahaan, dan manajemen operasional perusahaan.'],
                        ['icon' => 'ti-report-money', 'color' => 'info', 'name' => 'Akuntansi', 'title' => 'Sarjana Akuntansi (S.Ak.)', 'desc' => 'Mempelajari akuntansi keuangan, auditing, dan sistem informasi akuntansi.'],
                        ['icon' => 'ti-heart', 'color' => 'primary', 'name' => 'Ilmu Hukum', 'title' => 'Sarjana Hukum (S.H.)', 'desc' => 'Mempelajari sistem hukum, perundang-undangan, dan praktik advokasi.'],
                        ['icon' => 'ti-language', 'color' => 'success', 'name' => 'Sastra Inggris', 'title' => 'Sarjana Sastra (S.S.)', 'desc' => 'Mempelajari linguistik, kesusastraan, dan penerjemahan bahasa Inggris.'],
                        ['icon' => 'ti-currency-dollar', 'color' => 'secondary', 'name' => 'Ekonomi Syariah', 'title' => 'Sarjana Ekonomi (S.E.)', 'desc' => 'Mempelajari ekonomi dan keuangan berbasis prinsip syariah Islam.'],
                    ];
                @endphp
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card feature-card h-100 border-0 shadow-sm">
                        <div class="card-body p-5">
                            <div class="icon-shape icon-lg bg-{{ $p['color'] }}-subtle text-{{ $p['color'] }} rounded-3 mb-4 d-inline-flex align-items-center justify-content-center" style="width: 60px; height: 60px;"><i class="ti {{ $p['icon'] }} fs-2"></i></div>
                            <h5 class="fw-bold mb-2">{{ $p['name'] }}</h5>
                            <p class="text-muted small mb-3">{{ $p['title'] }}</p>
                            <p class="text-muted small mb-4">{{ $p['desc'] }}</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge bg-success-subtle text-success">Akreditasi A</span>
                                <small class="text-muted"><i class="ti ti-clock me-1"></i> 8 Semester</small>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-8 bg-body-tertiary">
        <div class="container">
            <div class="text-center mb-8">
                <span class="badge bg-primary-subtle text-primary border border-primary-subtle px-3 py-2 mb-3">Fasilitas</span>
                <h2 class="fw-bold display-6 mb-3">Fasilitas Unggulan</h2>
                <p class="text-muted mx-auto" style="max-width: 540px;">Nikmati berbagai fasilitas modern untuk mendukung perkuliahan Anda</p>
            </div>
            <div class="row g-4">
                @php
                    $fasilitas = [
                        ['icon' => 'ti-wifi', 'title' => 'WiFi 24 Jam', 'desc' => 'Akses internet cepat di seluruh area kampus'],
                        ['icon' => 'ti-books', 'title' => 'Perpustakaan Digital', 'desc' => 'Akses ke ribuan jurnal dan e-book nasional & internasional'],
                        ['icon' => 'ti-microscope', 'title' => 'Lab Modern', 'desc' => 'Laboratorium dengan peralatan terkini untuk praktikum'],
                        ['icon' => 'ti-building-stadium', 'title' => 'Sport Center', 'desc' => 'Fasilitas olahraga lengkap untuk pengembangan bakat'],
                    ];
                @endphp
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body text-center p-5">
                            <i class="ti {{ $f['icon'] }} fs-1 text-danger mb-3 d-block"></i>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <ul class="list-unstyled small text-white-50">
                        ...
                        <li class="mb-2"><i class="ti ti-mail me-2"></i>info@akademik.ac.id</li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-4">
