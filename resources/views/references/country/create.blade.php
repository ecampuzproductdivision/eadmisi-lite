...
<main class="p-2">
  <div class="row mb-3 align-items-center">
    <div class="col">
      <h3 class="mb-1 fw-bold text-dark">Tambah Negara</h3>
    ...
    <div class="col-xl-8 col-12">
      <div class="card border-0 shadow-sm">
        <div class="card-body p-5">
          <form action="{{ route('country.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            ...
            <div class="row g-4">
              ...
              <div class="col-md-12 col-12">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Indonesia, Malaysia" value="{{ old('name') }}" required>
              ...
              <div class="col-md-6 col-12">
                ...
                <input type="text" name="iso2" id="iso2" class="form-control" maxlength="2" placeholder="Contoh: ID, MY" value="{{ old('iso2') }}" style="text-transform: uppercase;" required>
              ...
              <div class="col-md-6 col-12">
                ...
                <input type="text" name="iso3" id="iso3" class="form-control" maxlength="3" placeholder="Contoh: IDN, MYS" value="{{ old('iso3') }}" style="text-transform: uppercase;" required>
              ...
              <div class="col-md-6 col-12">
                ...
                <input type="text" name="phone_code" id="phone_code" class="form-control" placeholder="Contoh: +62, +60" value="{{ old('phone_code') }}">
              ...
              <div class="col-md-6 col-12">
                ...
                <div class="form-check form-switch mt-2">
                  <input class="form-check-input" type="checkbox" name="status_toggle" id="status_toggle" checked role="switch">
                  <label class="form-check-label fw-semibold text-success ms-1" for="status_toggle" id="status_label">Aktif</label>
                  <input type="hidden" name="status" id="status_value" value="active">
                </div>
              </div>
