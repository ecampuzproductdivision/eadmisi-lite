  ...
  <div class="card border-1 mb-2">
    <div class="card-body p-4"> 
      <div class="row mb-3 align-items-center">
        <div class="col">
          <h3 class="mb-1 fw-bold text-dark">Ubah Mata Kuliah</h3>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <select name="prodi_id" class="form-select @error('prodi_id') is-invalid @enderror" required>
                ...
                @foreach($prodiList as $prodi)
                  <option value="{{ $prodi->prodiKode }}" {{ old('prodi_id', $course->prodi_id) == $prodi->prodiKode ? 'selected' : '' }}>
            ...
            <div class="mb-3">
              ...
              <input type="text" name="mk_kode" class="form-control @error('mk_kode') is-invalid @enderror" value="{{ old('mk_kode', $course->mk_kode) }}" required>
            </div>

            <div class="mb-3">
              <label class="form-label fw-semibold text-dark">Nama Mata Kuliah <span class="text-danger">*</span></label>
              <input type="text" name="mk_nama" class="form-control @error('mk_nama') is-invalid @enderror" value="{{ old('mk_nama', $course->mk_nama) }}" required>
            </div>

            <div class="mb-3">
              <label class="form-label fw-semibold text-dark">Nama Mata Kuliah Asing</label>
              <input type="text" name="mk_nama_asing" class="form-control" value="{{ old('mk_nama_asing', $course->mk_nama_asing) }}">
            </div>

            <div class="row">
              <div class="col-md-6 mb-3">
                <label class="form-label fw-semibold text-dark">Singkatan</label>
                <input type="text" name="mk_singkatan" class="form-control" value="{{ old('mk_singkatan', $course->mk_singkatan) }}">
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label fw-semibold text-dark">Semester Penawaran <span class="text-danger">*</span></label>
                <input type="number" name="mk_semester" class="form-control @error('mk_semester') is-invalid @enderror" value="{{ old('mk_semester', $course->mk_semester) }}" min="1" required>
              </div>
            </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <select name="mk_jenis" class="form-select" required>
                  @foreach(['Wajib', 'Pilihan', 'Wajib Peminatan', 'Pilihan Peminatan', 'Tugas Akhir/Skripsi/Thesis/Disertasi'] as $jenis)
                    <option value="{{ $jenis }}" {{ old('mk_jenis', $course->mk_jenis) == $jenis ? 'selected' : '' }}>{{ $jenis }}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-6 mb-3 d-flex align-items-end">
                <div class="form-check mb-2">
                  <input type="checkbox" name="mk_is_aktif" class="form-check-input" id="mk_is_aktif" value="1" {{ old('mk_is_aktif', $course->mk_is_aktif) == 1 ? 'checked' : '' }}>
          ...
          <div class="col-md-6">
              ...
              <div class="card-body p-4">
                ...
                <div class="row g-3">
                  <div class="col-md-4">
                    ...
                    <input type="number" name="mk_sks_tatap_muka" id="sks_tatap_muka" class="form-control SksInput" value="{{ old('mk_sks_tatap_muka', $course->mk_sks_tatap_muka) }}" min="0" required>
                  </div>
                  <div class="col-md-4">
                    <label class="form-label text-muted small fw-semibold">SKS Praktikum</label>
                    <input type="number" name="mk_sks_praktikum" id="sks_praktikum" class="form-control SksInput" value="{{ old('mk_sks_praktikum', $course->mk_sks_praktikum) }}" min="0" required>
                  </div>
                  <div class="col-md-4">
                    <label class="form-label text-muted small fw-semibold">SKS Praktek Lapangan</label>
                    <input type="number" name="mk_sks_praktek_lapangan" id="sks_praktek_lapangan" class="form-control SksInput" value="{{ old('mk_sks_praktek_lapangan', $course->mk_sks_praktek_lapangan) }}" min="0" required>
                  </div>
                </div>
            ...
            <div class="mb-3">
              ...
              <textarea name="mk_keterangan" class="form-control" rows="5">{{ old('mk_keterangan', $course->mk_keterangan) }}</textarea>
            </div>
          </div>
        </div>
