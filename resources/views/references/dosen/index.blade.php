...
@section('content')
@component('components.data-page-layout', ['data' => $dosens])
    @slot('breadcrumbs', [
    ...
    @slot('filters')
        ...
        <div class="col-md-3 col-12 d-flex gap-2">
            ...
            <a href="{{ route('dosen.index') }}" class="btn btn-white border px-3" title="Reset Filter"><i class="ti ti-refresh"></i></a>
        </div>
    @endslot
    @slot('exports')
