  ...
  <div class="card border-0 mb-6">
    <div class="card-body p-4">
      <div class="row align-items-center">
        <div class="col">
          <h3 class="mb-1 fw-bold">Tambah Program Studi</h3>
      ...
      <div class="card-body p-4">
        <div class="row g-4">
          <div class="col-md-3">
            ...
            <input type="number" name="prodiKode" class="form-control @error('prodiKode') is-invalid @enderror" value="{{ old('prodiKode') }}" placeholder="Contoh: 1004" required>
            @error('prodiKode') <div class="invalid-feedback">{{ $message }}</div> @enderror
          </div>
          
          <div class="col-md-3">
            <label class="form-label fw-semibold">Kode Singkat / Alias <span class="text-danger">*</span></label>
            <input type="text" name="prodiKodeUm" class="form-control @error('prodiKodeUm') is-invalid @enderror" value="{{ old('prodiKodeUm') }}" placeholder="Contoh: TI" required>
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="prodiNamaResmi" class="form-control @error('prodiNamaResmi') is-invalid @enderror" value="{{ old('prodiNamaResmi') }}" placeholder="Contoh: Teknik Informatika" required>
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="prodiNamaAsing" class="form-control" value="{{ old('prodiNamaAsing') }}" placeholder="Contoh: Informatics Engineering">
          </div>
          ...
          <div class="col-md-3">
            ...
            <select name="prodiJjarKode" class="form-select @error('prodiJjarKode') is-invalid @enderror" required>
              ...
              @foreach($jenjangList as $jenjang)
                <option value="{{ $jenjang->jjarKode }}" {{ old('prodiJjarKode') == $jenjang->jjarKode ? 'selected' : '' }}>
                  {{ $jenjang->jjarNama }}
                </option>
              @endforeach
            </select>
          ...
          <div class="col-md-3">
            ...
            <input type="text" name="prodiGelarKelulusan" class="form-control @error('prodiGelarKelulusan') is-invalid @enderror" value="{{ old('prodiGelarKelulusan') }}" placeholder="Contoh: S.Kom." required>
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="prodiGelarKelulusanFull" class="form-control" value="{{ old('prodiGelarKelulusanFull') }}" placeholder="Contoh: Sarjana Komputer">
          </div>

          <div class="col-md-6">
            <label class="form-label fw-semibold">Gelar Kelulusan Lengkap (English)</label>
            <input type="text" name="prodiGelarKelulusanFullAsing" class="form-control" value="{{ old('prodiGelarKelulusanFullAsing') }}" placeholder="Contoh: Bachelor of Computer Science">
          </div>
          ...
          <div class="col-md-3">
            ...
            <select name="prodiBahasaPengantar" class="form-select" required>
              <option value="Indonesia" {{ old('prodiBahasaPengantar') == 'Indonesia' ? 'selected' : '' }}>Indonesia</option>
              <option value="Inggris" {{ old('prodiBahasaPengantar') == 'Inggris' ? 'selected' : '' }}>Inggris</option>
              <option value="Bilingual" {{ old('prodiBahasaPengantar') == 'Bilingual' ? 'selected' : '' }}>Bilingual</option>
            </select>
          </div>
          ...
          <div class="col-md-3">
            ...
            <select name="prodiSistemKredit" class="form-select" required>
              <option value="SKS" {{ old('prodiSistemKredit') == 'SKS' ? 'selected' : '' }}>SKS</option>
              <option value="ECTS" {{ old('prodiSistemKredit') == 'ECTS' ? 'selected' : '' }}>ECTS</option>
              <option value="Paket" {{ old('prodiSistemKredit') == 'Paket' ? 'selected' : '' }}>Paket</option>
            </select>
          </div>

          <div class="col-md-3">
            <label class="form-label fw-semibold">SKS Lulus Minimum <span class="text-danger">*</span></label>
            <input type="number" name="prodiSksLulus" class="form-control @error('prodiSksLulus') is-invalid @enderror" value="{{ old('prodiSksLulus', 144) }}" required>
          ...
          <div class="col-md-3">
            ...
            <input type="number" name="prodiMaksMasaStudi" class="form-control @error('prodiMaksMasaStudi') is-invalid @enderror" value="{{ old('prodiMaksMasaStudi', 14) }}" required>
          ...
          <div class="col-md-4">
            ...
            <input type="email" name="prodiEmail" class="form-control @error('prodiEmail') is-invalid @enderror" value="{{ old('prodiEmail') }}" placeholder="Contoh: ti@univ.ac.id">
            @error('prodiEmail') <div class="invalid-feedback">{{ $message }}</div> @enderror
          </div>

          <div class="col-md-4">
            <label class="form-label fw-semibold">Website Resmi</label>
            <input type="url" name="prodiWebsite" class="form-control @error('prodiWebsite') is-invalid @enderror" value="{{ old('prodiWebsite') }}" placeholder="Contoh: https://ti.univ.ac.id">
          ...
          <div class="col-md-2">
            ...
            <select name="prodiIsEksakta" class="form-select">
              <option value="1" {{ old('prodiIsEksakta') == '1' ? 'selected' : '' }}>Eksakta</option>
              <option value="0" {{ old('prodiIsEksakta') == '0' ? 'selected' : '' }}>Non-Eksakta</option>
            </select>
          </div>
          ...
          <div class="col-md-2">
            ...
            <select name="prodiIsKampusMerdeka" class="form-select" required>
              <option value="Ya" {{ old('prodiIsKampusMerdeka') == 'Ya' ? 'selected' : '' }}>Ya</option>
              <option value="Tidak" {{ old('prodiIsKampusMerdeka') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="card-body p-4">
        <div class="row g-4">
          <div class="col-md-4">
            ...
            <select name="prodiFakKode" class="form-select @error('prodiFakKode') is-invalid @enderror" required>
              ...
              @foreach($fakultasList as $fakultas)
                <option value="{{ $fakultas->fakKode }}" {{ old('prodiFakKode') == $fakultas->fakKode ? 'selected' : '' }}>
                  {{ $fakultas->fakNama }}
                </option>
              @endforeach
            </select>
          ...
          <div class="col-md-4">
            ...
            <select name="prodiJurKode" class="form-select">
              ...
              @foreach($jurusanList as $jurusan)
                <option value="{{ $jurusan->jurKode }}" {{ old('prodiJurKode') == $jurusan->jurKode ? 'selected' : '' }}>
                  {{ $jurusan->jurNama }}
                </option>
              @endforeach
            </select>
          ...
          <div class="col-md-4">
            ...
            <select name="prodiProdidiktiKode" class="form-select @error('prodiProdidiktiKode') is-invalid @enderror" required>
              ...
              @foreach($diktiList as $dikti)
                <option value="{{ $dikti->prodidiktiKode }}" {{ old('prodiProdidiktiKode') == $dikti->prodidiktiKode ? 'selected' : '' }}>
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="prodiNomorSkDikti" class="form-control @error('prodiNomorSkDikti') is-invalid @enderror" value="{{ old('prodiNomorSkDikti') }}" placeholder="Contoh: 123/KPT/I/2026" required>
          ...
          <div class="col-md-4">
            ...
            <input type="date" name="prodiTanggalSkDikti" class="form-control @error('prodiTanggalSkDikti') is-invalid @enderror" value="{{ old('prodiTanggalSkDikti') }}" required>
          ...
          <div class="col-md-4">
            ...
            <input type="date" name="prodiTanggalBerakhirSkDikti" class="form-control" value="{{ old('prodiTanggalBerakhirSkDikti') }}">
          </div>

          <div class="col-md-4">
            <label class="form-label fw-semibold">Tanggal Berdiri Pertama / Beroperasi <span class="text-danger">*</span></label>
            <input type="date" name="prodiTanggalBerdiri" class="form-control @error('prodiTanggalBerdiri') is-invalid @enderror" value="{{ old('prodiTanggalBerdiri') }}" required>
          ...
          <div class="col-md-4">
            ...
            <select name="prodiSahrKode" class="form-select @error('prodiSahrKode') is-invalid @enderror" required>
              ...
              @foreach($statusList as $status)
                <option value="{{ $status->sahrKode }}" {{ old('prodiSahrKode', 'A') == $status->sahrKode ? 'selected' : '' }}>
                  {{ $status->sahrNama }}
                </option>
              @endforeach
            </select>
          ...
          <div class="col-md-4">
            ...
            <select name="prodiModelrId" class="form-select">
              ...
              @foreach($modelList as $model)
                <option value="{{ $model->modelrId }}" {{ old('prodiModelrId', 1) == $model->modelrId ? 'selected' : '' }}>
                  {{ $model->modelrNama }}
                </option>
              @endforeach
            </select>
          ...
          <div class="col-md-4">
            ...
            <select name="prodiFpkrKode" class="form-select">
              ...
              @foreach($frekuensiList as $frekuensi)
                <option value="{{ $frekuensi->fpkrKode }}" {{ old('prodiFpkrKode') == $frekuensi->fpkrKode ? 'selected' : '' }}>
                  {{ $frekuensi->fpkrNama }}
                </option>
              @endforeach
            </select>
          ...
          <div class="col-md-4">
            ...
            <select name="prodiPpkrKode" class="form-select">
              ...
              @foreach($pelaksanaanList as $pelaksanaan)
                <option value="{{ $pelaksanaan->ppkrKode }}" {{ old('prodiPpkrKode') == $pelaksanaan->ppkrKode ? 'selected' : '' }}>
          ...
          <div class="col-md-4">
            ...
            <select name="prodiSemIdStatusDihapus" class="form-select">
              ...
              <option value="20191" {{ old('prodiSemIdStatusDihapus') == '20191' ? 'selected' : '' }}>2019 - 1</option>
              <option value="20192" {{ old('prodiSemIdStatusDihapus') == '20192' ? 'selected' : '' }}>2019 - 2</option>
              <option value="20201" {{ old('prodiSemIdStatusDihapus') == '20201' ? 'selected' : '' }}>2020 - 1</option>
              <option value="20202" {{ old('prodiSemIdStatusDihapus') == '20202' ? 'selected' : '' }}>2020 - 2</option>
            </select>
          </div>
        </div>
      </div>
        ...
        <div class="row g-4">
          <div class="col-md-6">
            ...
            <select name="id_kaprodi" class="form-select @error('id_kaprodi') is-invalid @enderror" required>
              ...
              @foreach($dosenList as $dosen)
                <option value="{{ $dosen->id_dosen }}" {{ old('id_kaprodi') == $dosen->id_dosen ? 'selected' : '' }}>
                  {{ $dosen->nama_lengkap }} (NIDN: {{ $dosen->nidn ?? '-' }})
                </option>
              @endforeach
            </select>
            <div class="form-text text-muted">Hanya menampilkan dosen dengan status aktif.</div>
          ...
          <div class="col-md-6">
            ...
            <select name="id_sekretaris_prodi" class="form-select @error('id_sekretaris_prodi') is-invalid @enderror">
              ...
              @foreach($dosenList as $dosen)
                <option value="{{ $dosen->id_dosen }}" {{ old('id_sekretaris_prodi') == $dosen->id_dosen ? 'selected' : '' }}>
                  {{ $dosen->nama_lengkap }} (NIDN: {{ $dosen->nidn ?? '-' }})
                </option>
              @endforeach
            </select>
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="prodiOperatorNama" class="form-control" value="{{ old('prodiOperatorNama') }}" placeholder="Nama Operator">
          </div>

          <div class="col-md-6">
            <label class="form-label fw-semibold">No Telp Operator</label>
            <input type="text" name="prodiOperatorNoHp" class="form-control" value="{{ old('prodiOperatorNoHp') }}" placeholder="No HP Operator">
          </div>

          <div class="col-md-12">
            <label class="form-label fw-semibold">Alamat Kantor Prodi</label>
            <textarea name="prodiAlamat" class="form-control" rows="2" placeholder="Gedung, lantai, jalan...">{{ old('prodiAlamat') }}</textarea>
          </div>

          <div class="col-md-4">
            <label class="form-label fw-semibold">Telepon Kantor</label>
            <input type="text" name="prodiTelp" class="form-control" value="{{ old('prodiTelp') }}" placeholder="Contoh: 021-...">
          </div>

          <div class="col-md-4">
            <label class="form-label fw-semibold">Fax</label>
            <input type="text" name="prodiFax" class="form-control" value="{{ old('prodiFax') }}" placeholder="Contoh: 021-...">
          </div>

          <div class="col-md-4">
            <label class="form-label fw-semibold">Kontak Person / Humas</label>
            <input type="text" name="prodiKontakPerson" class="form-control" value="{{ old('prodiKontakPerson') }}" placeholder="Nama Kontak Humas">
          </div>
        </div>
      </div>
    </div>
