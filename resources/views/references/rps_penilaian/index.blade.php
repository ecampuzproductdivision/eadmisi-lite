...
<main class="p-4">
  ...
  {{-- HEADER BANNER                                                --}}
  {{-- ============================================================ --}}
  <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #090d16 0%, #1e1b4b 50%, #1e3a8a 100%); border-radius: 20px; overflow: hidden; position: relative;">
