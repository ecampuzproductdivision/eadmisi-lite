...
<main class="p-2">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Add Navigation Menu</li>
        </ol>
    </nav>
    <hr>
    ...
    <div class="d-flex align-items-top gap-3 my-5">
        ...
        <div>
            ...
            <p class="text-muted mb-0">Create a new sidebar section or nested link in the navigation menu.</p>
        </div>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <select name="category" id="category" class="form-select" required>
                            ...
                            <option value="MASTER_DATA" {{ old('category') == 'MASTER_DATA' ? 'selected' : '' }}>MASTER_DATA</option>
                            <option value="TRANSACTION" {{ old('category') == 'TRANSACTION' ? 'selected' : '' }}>TRANSACTION</option>
