...
<main class="p-2">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Edit Page Registration</li>
        </ol>
    </nav>
    <hr>
    ...
    <div class="d-flex align-items-top gap-3 my-5">
        ...
        <div>
            <h1 class="mb-1 fw-bold">Edit Page Registration</h1>
            <p class="text-muted mb-0">Update configuration for page: <strong>{{ $page->page_name }}</strong>.</p>
        </div>
    </div>
    ...
    <div class="card border-1 shadow-sm px-4 py-4">
        <div class="col-xl-12 col-12">
            <form action="{{ route('pages.update', $page->id) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <input type="text" name="page_name" id="page_name" class="form-control" placeholder="e.g. Sales Report" value="{{ old('page_name', $page->page_name) }}" required>
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <input type="text" name="page_code" id="page_code" class="form-control" placeholder="e.g. PAGE_SALES_REPORT" value="{{ old('page_code', $page->page_code) }}" required>
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <select name="is_active" id="is_active" class="form-select" required>
                            <option value="1" {{ old('is_active', $page->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Active (Enforce permissions)</option>
                            <option value="0" {{ old('is_active', $page->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Disabled (Bypass checks)</option>
                        </select>
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <select name="menu_id" id="menu_id" class="form-select">
                            ...
                            @foreach($menus as $menu)
                                <option value="{{ $menu->id }}" {{ old('menu_id', $page->menu_id) == $menu->id ? 'selected' : '' }}>{{ $menu->menu_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <input type="text" name="route_path" id="route_path" class="form-control" placeholder="e.g. /sales/report" value="{{ old('route_path', $page->route_path) }}">
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <input type="text" name="component_name" id="component_name" class="form-control" placeholder="e.g. SalesReportController" value="{{ old('component_name', $page->component_name) }}">
                    </div>
