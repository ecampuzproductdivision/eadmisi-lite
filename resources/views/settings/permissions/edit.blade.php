...
<main class="p-2">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Edit Action Permission</li>
        </ol>
    </nav>
    <hr>
    ...
    <div class="d-flex align-items-top gap-3 my-5">
        ...
        <div>
            <h1 class="mb-1 fw-bold">Edit Action Permission</h1>
            <p class="text-muted mb-0">Update action capability token: <strong>{{ $permission->permission_name }}</strong>.</p>
        </div>
    </div>
            ...
            <form action="{{ route('permissions.update', $permission->id) }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <input type="text" name="permission_name" id="permission_name" class="form-control" placeholder="e.g. print, download, export" value="{{ old('permission_name', $permission->permission_name) }}" required>
                    ...
                    <div class="col-12 d-flex gap-2 justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4">Update Action</button>
                    </div>
                </div>
            </form>
        </div>
